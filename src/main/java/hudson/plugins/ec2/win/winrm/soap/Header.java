...
import static hudson.plugins.ec2.win.winrm.soap.Utilities.*;
...
public class Header
{
  ...
  void toElement(Element header)
  {
    ...
    if (shellId != null) {
      header.addElement(QName.get("SelectorSet", Namespaces.NS_WSMAN_DMTF)).addElement(QName.get("Selector", Namespaces.NS_WSMAN_DMTF)).addAttribute("Name", "ShellId")
      .addText(shellId);
     }
